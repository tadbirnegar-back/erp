...
class ShowComprehensiveExamQuestionResource extends ResourceCollection
{
    /**
    ...
    {
        $questionTimeSetting = Setting::where('key', 'time_per_questions_comprehensive')->first();
        $examNumberSetting = Setting::where('key', 'question_numbers_perExam_comprehensive')->first();
